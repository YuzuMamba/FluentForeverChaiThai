/** Thai script course — PLACEHOLDER, to be replaced with the real screen. */
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-0)', display: 'grid', placeItems: 'center', padding: 24 }}>
      <div className="card anim-pop" style={{ padding: 40, textAlign: 'center', maxWidth: 480 }}>
        <h1 style={{ fontSize: 28, marginBottom: 8 }}>Thai script course</h1>
        <p style={{ color: 'var(--text-2)', marginBottom: 24 }}>ScriptScreen placeholder</p>
